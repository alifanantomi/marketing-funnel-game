...
import FacilitatorGuidelinesCarousel from "./facilitator-guidelines-carousel"
            ...
            {step === 1 && (
              ...
              >
                <div className="flex flex-col md:flex-row gap-6 items-center">
                  ...
                  <div className="w-full md:w-2/3">
                    <h2 className="text-3xl text-center font-bold text-retro-dark mb-4">Facilitator Guidelines</h2>
                    <div className="w-full flex justify-center">
                      <FacilitatorGuidelinesCarousel />
                    </div>
                  </div>
                </div>
                <ActionButton />
